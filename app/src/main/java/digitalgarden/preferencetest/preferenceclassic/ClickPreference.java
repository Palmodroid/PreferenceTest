...
/**
 http://www.java2s.com/Code/Android/Core-Class/AcustompreferencetypeThepreferencecountsthenumberofclicksithasreceivedandstoresretrievesitfromthestorage.htm
 */
public class ClickPreference extends Preference
    ...
    setWidgetLayoutResource(R.layout.click_preference_widget);
    }
    ...
    final TextView myTextView = (TextView) view.findViewById(R.id.click_widget);
    if (myTextView != null) {
